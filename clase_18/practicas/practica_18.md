...
```powershell
py evaluar.py entregas/clase_18/nombre clase_18/tests
py evaluar.py entregas/clase_18/nombre clase_18/tests entregas/clase_18/nombre/test_estudiante.py
```
