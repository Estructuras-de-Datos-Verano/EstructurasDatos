# Actividad de Proyecto Github Clase 3
José Iván Reyna Blanco
- Definición propia de TDA: Por sus siglas, un tipo de dato abstracto es una estructura a la que se refiere para implementar cierto tipo de datos. Contrario a un diccionario que ya está dado como un objeto en python, los TDA permiten implementarse de distintas formas. Por ejemplo, una pila (LIfO) puede implementarse con la lista ordinaria de python y sus métodos como .pop() o podemos implementarla incluso con clases usando POO.
