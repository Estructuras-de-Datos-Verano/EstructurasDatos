...
visitar_pagina(mi_historial, "futbol_libre.com")
visitar_pagina(mi_historial, "github.com")
visitar_pagina(mi_historial, "slither.io")

print("Historial inicial:", mi_historial)


pagina_anterior = regresar(mi_historial)
print(f"-> Hiciste clic en 'Regresar'. Volviste a: {pagina_anterior}")
print("Historial actual:", mi_historial)
