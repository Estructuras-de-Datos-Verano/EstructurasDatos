...
def orden_eliminacion(n: int) -> list[int]:
    ...
    while vivos:
        if len(vivos) == 1:
            ...
            salvado = vivos.popleft()  # Se salva el primer niño
            vivos.append(salvado)  # Se coloca al final de la cola
            eliminado = vivos.popleft()  # Se elimina el siguiente niño
            eliminados.append(eliminado)  # Se registra el niño eliminado
