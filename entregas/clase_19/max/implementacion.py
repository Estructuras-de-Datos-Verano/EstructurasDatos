...
def normalizar_grafo_dirigido(grafo: Mapping[str, Sequence[str]],) -> dict[str, list[str]]:
...
def grados_entrada(grafo: Mapping[str, Sequence[str]],) -> dict[str, int]:
...
def orden_topologico(grafo: Mapping[str, Sequence[str]],) -> list[str] | None:
    grafo = normalizar_grafo_dirigido(grafo)
...
def es_orden_topologico(grafo: Mapping[str, Sequence[str]], orden: Sequence[str],) -> bool:
    grafo = normalizar_grafo_dirigido(grafo)
    if len(orden) != len(grafo):
        return False
...
def ordenar_cursos(numero_cursos: int,prerrequisitos: list[tuple[int, int]],) -> list[int] | None:
...
def puede_completar_cursos(numero_cursos: int, prerrequisitos: list[tuple[int, int]],) -> bool:
