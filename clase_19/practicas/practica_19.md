...
Esta práctica es asíncrona y no exige revisión cruzada. Trabaja únicamente dentro de `entregas/clase_19/nombre/`.

## Entrega exacta

```text
entregas/clase_19/nombre/
├── implementacion.py
├── test_estudiante.py
├── notebook.md
├── discusion.md
...
Copia `clase_19/src/ordenamiento_topologico_base.py` como `implementacion.py` y conserva firmas, retornos y excepciones.
...
```bash
python3 evaluar.py entregas/clase_19/nombre clase_19/tests
python3 evaluar.py entregas/clase_19/nombre clase_19/tests entregas/clase_19/nombre/test_estudiante.py
```

Windows:

```powershell
py evaluar.py entregas/clase_19/nombre clase_19/tests
py evaluar.py entregas/clase_19/nombre clase_19/tests entregas/clase_19/nombre/test_estudiante.py
```
