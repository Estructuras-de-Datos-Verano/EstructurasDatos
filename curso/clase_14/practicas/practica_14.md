...
Crea `entregas/nombre/clase_14/` con:
...
```powershell
py scripts/evaluar.py entregas/nombre/clase_14 curso/clase_14/tests entregas/nombre/clase_14/test_estudiante.py
```
...
- [ ] Solo modifiqué `entregas/nombre/clase_14/`.
...
| Pruebas propias y scripts/evaluar.py | 10 |
| Revisión técnica | 10 |
