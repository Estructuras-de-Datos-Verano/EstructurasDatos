...
- usar `scripts/evaluar.py` para ejecutar pruebas públicas;
...
10. Ejecuta la evaluación con `scripts/evaluar.py`.
...
## 7. Pruebas
## 8. Cambio técnico: scripts/evaluar.py
...
```bash
python3 scripts/evaluar.py entregas/nombre/clase_11 curso/clase_11/tests
```
...
## Nuevo flujo con `scripts/evaluar.py`
...
- comentar al menos una cosa sobre claridad de explicación, invariante del BST, prueba diseñada, recorridos, redacción técnica o uso correcto de `scripts/evaluar.py`.
...
- [ ] Ejecuté `python3 scripts/evaluar.py entregas/nombre/clase_11 curso/clase_11/tests`.
