...
- usar `scripts/evaluar.py` para ejecutar pruebas públicas sobre una entrega;
...
`discusion.md` es un documento técnico: argumenta lista vs árbol, invariante, inserción, recorridos, altura, pruebas, `scripts/evaluar.py` y problemas relacionados.
...
Puedes usar `src/arboles.py` como molde para crear tu `entregas/nombre/clase_11/implementacion.py`.
