...
- usar `scripts/evaluar.py` con tests públicos y tests extra;
...
5. Ejecuta `scripts/evaluar.py` con tests públicos.
...
## 11. scripts/evaluar.py y pruebas
...
```bash
python3 scripts/evaluar.py entregas/nombre/clase_12 curso/clase_12/tests
```

Windows PowerShell:

```powershell
py scripts/evaluar.py entregas/nombre/clase_12 curso/clase_12/tests
```

o:

```powershell
python scripts/evaluar.py entregas/nombre/clase_12 curso/clase_12/tests
```

`scripts/evaluar.py` ejecuta internamente `pytest -v` y permite que los tests importen:
...
```text
scripts/evaluar.py <carpeta_entrega> <tests_publicos> [tests_extra]
```
...
```powershell
py scripts/evaluar.py entregas/max/clase_12 curso/clase_12/tests entregas/leo/clase_12/test_estudiante.py
```

o:

```powershell
python scripts/evaluar.py entregas/max/clase_12 curso/clase_12/tests entregas/leo/clase_12/test_estudiante.py
```
...
python3 scripts/evaluar.py entregas/nombre_compañero/clase_12 curso/clase_12/tests entregas/mi_nombre/clase_12/test_estudiante.py
```
...
git fetch origin
git switch nombre-rama-del-compañero
py scripts/evaluar.py entregas/nombre_compañero/clase_12 curso/clase_12/tests entregas/mi_nombre/clase_12/test_estudiante.py
```

o:

```powershell
python scripts/evaluar.py entregas/nombre_compañero/clase_12 curso/clase_12/tests entregas/mi_nombre/clase_12/test_estudiante.py
```
...
```bash
python3 scripts/evaluar.py entregas/ana/clase_12 curso/clase_12/tests entregas/luis/clase_12/test_estudiante.py
```
...
- [ ] Ejecuté `scripts/evaluar.py` con tests públicos.
...
| Pruebas propias y evaluación con `scripts/evaluar.py` | 15 |
