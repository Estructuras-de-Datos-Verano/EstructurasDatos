...
```bash
python3 scripts/evaluar.py entregas/nombre/clase_12 curso/clase_12/tests entregas/mi_nombre/clase_12/test_estudiante.py
```
...
`reporte_pytest.md` contiene salida completa de `scripts/evaluar.py`.
