...
Trabaja únicamente en `entregas/nombre/clase_20/`.
...
Copia `curso/clase_20/src/seleccion_estrategias_base.py` como `implementacion.py`. Conserva firmas, dataclasses, excepciones y vocabulario.
