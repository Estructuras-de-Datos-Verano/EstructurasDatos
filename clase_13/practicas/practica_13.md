...
5. Ejecuta pruebas públicas con `evaluar.py`.
...
python3 evaluar.py entregas/clase_13/nombre_companero clase_13/tests entregas/clase_13/mi_nombre/test_estudiante.py
```
...
git fetch origin
git switch clase-13-nombre-companero
py evaluar.py entregas/clase_13/nombre_companero clase_13/tests entregas/clase_13/mi_nombre/test_estudiante.py
```
...
```bash
python3 evaluar.py entregas/clase_13/max clase_13/tests
```
