...
git add entregas/clase_14/nombre
...
> [!CAUTION]
> El último comando debe mostrar únicamente `entregas/clase_14/nombre/`. Si aparecen otra clase, otro alumno, `.DS_Store`, `__pycache__` o `.pyc`, no abras todavía el PR.
