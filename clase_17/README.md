...
> [!IMPORTANT]
> No respondas dentro del notebook. Todas las respuestas van en `entregas/clase_17/nombre/notebook.md`.
...
```bash
python3 -m pip install -r clase_17/requirements.txt
```

En Windows PowerShell:

```powershell
py -m pip install -r clase_17/requirements.txt
```
