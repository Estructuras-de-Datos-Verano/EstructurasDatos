...
Esta práctica es asíncrona. No exige revisión cruzada. Trabaja únicamente dentro de `entregas/clase_17/nombre/`.

## Entrega exacta

```text
entregas/clase_17/nombre/
├── implementacion.py
├── test_estudiante.py
├── notebook.md
├── discusion.md
...
Copia `clase_17/src/estructuras_bfs_base.py` como `implementacion.py` y conserva todas las firmas públicas. No uses `collections.deque`, `list.pop(0)` ni heap para resolver las operaciones obligatorias.
...
```bash
python3 evaluar.py entregas/clase_17/nombre clase_17/tests
python3 evaluar.py entregas/clase_17/nombre clase_17/tests entregas/clase_17/nombre/test_estudiante.py
```

Windows PowerShell:

```powershell
py evaluar.py entregas/clase_17/nombre clase_17/tests
py evaluar.py entregas/clase_17/nombre clase_17/tests entregas/clase_17/nombre/test_estudiante.py
```
